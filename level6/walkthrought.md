La premiere idée en voyant le code source me parait etre un heap overflow. En effet strcpy prend en argument un buffer sur lequel on a la main.

Je vais donc essayer de trouver l'offset du buffer.
